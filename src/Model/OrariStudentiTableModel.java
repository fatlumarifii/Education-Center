 ...
 * @author Arbër Suka
 */
public class OrariStudentiTableModel extends AbstractTableModel {
    
    private final String [] columnNames = {"Lenda","Data","Ora_Fillimit","Ora_Mbarimit"};
    
    private List <Orari> data;
    
    public OrariStudentiTableModel(List<Orari>data){
        this.data = data;
    }

    public OrariStudentiTableModel() {
